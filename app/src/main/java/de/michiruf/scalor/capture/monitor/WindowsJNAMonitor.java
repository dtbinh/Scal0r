...
/**
 * @author Cihad Turhan
 * @see <a href="http://stackoverflow.com/questions/6998438/jna-library-slower-screenshot-than-robot-class">Stackoverflow</a>
 */
@Singleton
public class WindowsJNAMonitor implements Monitor {
    ...
    @Inject
    public WindowsJNAMonitor(Configuration configuration) {
    ...
    private void updateDimens() {
        bounds = new Rectangle(configuration.getScanX(), configuration.getScanY(),
